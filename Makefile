...
ALL: Sod_intermediate_pressure_demo Sod_solution_demo Reverse_Sod_solution_demo
...
Reverse_Sod_solution_demo: Sod_module.o Reverse_Sod_solution_demo.o
	$(LINK) $(LFLAGS) -o Reverse_Sod_solution_demo Reverse_Sod_solution_demo.o Sod_module.o
...
Reverse_Sod_solution_demo.o: Reverse_Sod_solution_demo.f90
	$(FORT) $(FFLAGS) -c Reverse_Sod_solution_demo.f90

clean: *.o *.mod
	/bin/rm *.o *.mod

sweep: *.o *.mod
	/bin/rm *.o *.mod Sod_solution_demo Reverse_Sod_solution_demo Sod_intermediate_pressure_demo
